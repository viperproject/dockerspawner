...
setup_args = dict(
    ...
    description="""Dockerspawner: A custom spawner for Web-IDE.""",
    long_description="Spawn single-user code-server containers with Docker.",
    author="Chair of Programming Methodology, ETH Zurich",
    author_email="viper@ethz.ch",
    url="https://www.pm.inf.ethz.ch/",
    license="BSD",
